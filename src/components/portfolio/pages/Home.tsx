...
const Home = () => {
  return (
    <div
      className={
        "select-text h-full flex flex-col items-center w-full bg-retro-medium"
      }
    >
      <div
        className={
          "flex flex-col items-center justify-between h-full border-x-3 border-retro-dark bg-retro-white"
        }
        style={{
      ...
      >
        <div
          className={
            "flex flex-col items-center py-12 border-retro-dark w-full"
          }
        >
          <div className={"w-fit"}>
        ...
        <div>
          <div className={"flex mb-[60px] flex-col items-center"}>
            <h1 className={"font-extrabold"}>Ismail Feham</h1>
