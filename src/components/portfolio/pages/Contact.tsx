...
const Contact = () => {
    ...
    return (
        <div>
            <h2>Reach me out!</h2>
            <p>
                I&apos;m always open to new opportunities and collaborations. Feel free to reach out to me through the form
                below
                or directly at <a href="mailto:ismail.feham64@gmail.com"><b>ismail.feham64@gmail.com</b></a>
            </p>
            <br />
...
const FieldInput = (props: FieldInputProps) => {
    const fieldClasses = "focus:outline-retro-dark focus:outline focus:outline-1 border-2 border-retro-dark rounded-sm px-2 py-1";

    return (
        <div className="flex flex-col mt-3">
            <label>
                {!props.optional && <span className={"text-red-700 font-normal"}>* </span>}
                {props.label}
            </label>
